...
enum DesignLabels {
    ...
    static let webViewersOff = "Beta off — nearby only."
    static let webViewersReady = "Beta ready — web viewers can join through Supabase."
    static let webViewersMissingConfig = "Beta unavailable — Supabase config missing."
    ...
    static let settingsHint = "Open timer, permissions, grid and HD options"
    static let hideQRCode = "Hide QR code"
    static let showQRCode = "Show QR code"
    static let qrToggleHint = "Lets crew members scan to join the session"
    static let backHint = "Returns to the home screen"
    ...
    // MARK: - Debug
    static let debugSupabaseWrites = "Supabase writes"
    static let debugSupabaseReads = "Supabase reads"
    static let debugSupabasePolls = "Supabase polls"
