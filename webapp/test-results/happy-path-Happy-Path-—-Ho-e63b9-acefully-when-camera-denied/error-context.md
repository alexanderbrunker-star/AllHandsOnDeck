...
- Name: happy-path.spec.ts >> Happy Path — Host Page >> shows camera error gracefully when camera denied
- Location: e2e/happy-path.spec.ts:151:3
...
- generic [ref=e5]:
  - generic [ref=e6]: 🏴‍☠️
  - paragraph [ref=e7]: "NotSupportedError: Not supported"
